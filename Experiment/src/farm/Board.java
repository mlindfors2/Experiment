...
public class Board extends JPanel {// implements ActionListener {
	...
	public void drawCow(Graphics2D g2d) {
		...
		if (choice == 0) {
			g2d.drawImage(cowleft1, x, 400, x + 80, 400 + 80, 0, 0, 2120, 1800, null);
			System.out.println("left 2 " + x);
		} else if (choice == 1) {
			g2d.drawImage(cowleft2, x, 400, x + 80, 400 + 80, 0, 0, 2120, 1800, null);
		} else if (choice == 2) {
			g2d.drawImage(cowleft3, x, 400, x + 80, 400 + 80, 0, 0, 2120, 1800, null);
