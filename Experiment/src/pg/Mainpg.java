...
public class Mainpg {
	...
	static LinkedList<ChatClient> list = new LinkedList<ChatClient>();//Anv�nds f�r stresstester med meddelande
...
//			System.out.println(sc.getUserList().getUser(i).getName()); //Printar ut alla anv�ndare inloggad p� servern
//		
		}
